...
public class BookList {
    ...
    private void initializeBooks() {
        books.add(new Book("978-0-73829-2849720-5-9", "The Secret History", new Category("Thriller"), "Penguin Books", Year.of(2018), 12.5, 18.0, 16.5, new Author("Donna", "", "Tartt"),27));
        ...
        System.out.println("ArrayList of books has been written to " + filePath);
    }
